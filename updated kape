...
print(stda)
print(
    "4...the user who places the pawns in any of the above small list can remove any one pawn from his opponent's which you like")
print(
    ...
    if len(a) > 2 and len(b) > 2:
        ...
        if p in a:
            ...
            if q in temp or flag[-1].isdigit():
                ...
                a.remove(p)
                a.append(q)
                check_akape(stda, a, b, z, n)  #check user1 has made a kape
        print("user1:" + str(a) + "   user2 :" + str(b))

        #check whether b(user2) is blocked by user 1
        flag = 1
        for i in b:
            for j in moves[i - 1]:
                if j not in a and j not in b:
        ...
        if p in b:
            ...
            if q in temp or flag[-1].isdigit():
                ...
                b.remove(p)
                b.append(q)
                check_bkape(stdb, a, b, z, n) #check user2 has made a kape
        print("user1:" + str(a) + "   user2 :" + str(b))
    else:
        finish(a,b)
